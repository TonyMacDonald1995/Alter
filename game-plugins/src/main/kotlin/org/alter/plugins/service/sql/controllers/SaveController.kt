...
import org.alter.plugins.service.sql.models.VarpModel.autoIncrement
import org.alter.plugins.service.sql.serializers.SQLSerializer
import org.jetbrains.exposed.sql.*
import org.jetbrains.exposed.sql.SqlExpressionBuilder.eq
import org.jetbrains.exposed.sql.transactions.transaction

object SaveController : Controller() {
    fun createPlayer(client: Client, world: World): PlayerUID {
        ...
        transaction {
            ...
            // Let's build the generic inventory
        ...
        transaction {
            ...
            serialize.skillModels.forEach { skill ->
                SkillModel.update({
                    ...
                    it[this.xp] = client.getSkills().getCurrentXp(skill[SkillModel.skill])
                }
            }
            ...
            getContainers(client).forEach { container ->
                ...
                if(dbContainer != null) {
                    ...
                    dbContainer.items.forEach {item ->
